...
if (!function_exists("wpm_6310_social_icon")) {
...
if(!function_exists('wpm_6310_extract_contact_info')){
		...
		if ($data) {
			...
			if($contacts){
				foreach ($contacts as $contact) {
					...
					$str .= "<div class='wpm-custom-fields-list-{$ids}'><div class='wpm-custom-fields-list-label-{$ids}'>" . str_replace("\\", "", $contact[0]) . "</div> <div class='wpm-custom-fields-list-content-{$ids}'>{$contact[1]}</div></div>";
				}    
			}       
		}
		if($str){
...
if (!function_exists('wpm_6310_extract_member_description')) {
	...
	function wpm_6310_team_member_details()
	{
		...
		if ($data['styledata']['contact_info']) {
			...
			if($contacts){
				foreach ($contacts as $contact) {
					$contact = explode("||||", $contact);
					$str .= "<div class='wpm-custom-fields-list'><div class='wpm-custom-fields-list-label'>" . str_replace("\\", "", $contact[0]) . "</div> <div class='wpm-custom-fields-list-content'>{$contact[1]}</div></div>";
				}    
			}   
		}
		$data['contact'] = $str;
...
if (!function_exists('wpm_team_showcase_supreme_install')) {
	function wpm_team_showcase_supreme_install()
	{
		...
		if (!($memberData)) {
			...
			$sql = "INSERT INTO {$member_table} (name, designation, profile_details_type, profile_url, open_new_tab, profile_details, effect, image, iconids, iconurl, category, contact_info) VALUES
			('Adam Smith', 'CEO', '2', '', '0', '{$details}', 'top', 'https://www.wpmart.org/wp-content/uploads/2020/04/1.jpg', '1,37,24', 'https://www.linkedin.com||||admin@gmail.com||||+123456789', '{$category1}', '{$contact}'),
			('George Michel', 'Sales Agent', '2', '', '0', '{$details}', 'top', 'https://www.wpmart.org/wp-content/uploads/2020/04/2.jpg', '2,37,38', 'https://www.facebook.com||||admin@gmail.com||||+123456789', '{$category2}', '{$contact}'),
			('Jeson Smith', 'Web Developer', '2', '', '0', '{$details}', 'top', 'https://www.wpmart.org/wp-content/uploads/2020/04/3.jpg', '2,1,24', 'https://www.facebook.com||||https://www.linkedin.com||||+123456789', '{$category3}', '{$contact}'),
			('Jones Lee', 'Web Designer', '2', '', '0', '{$details}', 'top', 'https://www.wpmart.org/wp-content/uploads/2020/04/4.jpg', '27,1,25', 'https://www.facebook.com||||admin@gmail.com||||+123456789', '{$category4}', '{$contact}')";
