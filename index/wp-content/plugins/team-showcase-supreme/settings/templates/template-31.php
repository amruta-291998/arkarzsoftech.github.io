            ...
            <div class="row">
              ...
              <div class="wpm-col-6">
                <table class="table table-responsive wpm_6310_admin_table social_act_field">
                  <tr height="45">
                    <td width='55%'><b>Social Icon Margin Top</b></td>
                    <td>
                  ...
                  <tr height="45">
                    <td width='55%'><b>Social Icon Margin Bottom</b></td>
                    <td>
                ...
                <div<?php echo $link_type ?>>
                  ...
                  <figcaption>
                    <div class="wpm_6310_team_style_31_caption">
                      <div class="wpm_6310_team_style_31_title"><?php echo $value['name'] ?></div>
                      <div class="wpm_6310_team_style_31_designation"><?php echo $value['designation'] ?></div>
                      <?php
