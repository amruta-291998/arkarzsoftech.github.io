              ...
              <div class="wpm-6310-col-<?php echo $desktop_row; ?>">
                <div<?php echo $link_type ?>>
                  <div class="wpm_6310_team_style_12_pic">
                    <img src="<?php echo $value['image'] ?>" class="img-responsive" alt="<?php echo $value['name'] ?>">
                  </div>

                  <div class="wpm_6310_team_style_12_team_content">
                    <div class="wpm_6310_team_style_12_title"><?php echo $value['name'] ?></div>
                    <div class="wpm_6310_team_style_12_designation"><?php echo $value['designation'] ?></div>
