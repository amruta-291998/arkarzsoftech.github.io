              ...
              <div class="wpm-6310-col-<?php echo $desktop_row; ?>">
                <div<?php echo $link_type ?>>
                  <div class="wpm_6310_team_style_13_pic">
                    <img src="<?php echo $value['image'] ?>" class="img-responsive <?php echo $allStyle[5] ?>" alt="<?php echo $value['name'] ?>">
                  </div>
                  <div class="wpm_6310_team_style_13_team_content">
                    <div class="wpm_6310_team_style_13_title"><?php echo $value['name'] ?></div>
                    <div class="wpm_6310_team_style_13_designation"><?php echo $value['designation'] ?></div>
                    <?php
