...
function wpm_template_01_10() {
   ...
   if (empty($_GET['styleid'])) {
      ...
      wp_enqueue_script('wpm-wpm-6310-jquery-ui-js', 'https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js', array('jquery'));
      wp_enqueue_style('wpm-wpm-6310-jquery-ui', 'https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.css');
