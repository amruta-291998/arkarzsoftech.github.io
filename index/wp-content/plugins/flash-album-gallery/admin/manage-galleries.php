    ...
    <?php if(current_user_can('FlAG Manage others gallery')){ ?>
        ...
        <div class="flag-wrap">
	        ...
	        if ( ! $flag->options['license_name'] ) {
		        ?>
		        <div style="margin: 40px 0; padding: 10px; background-color: #fff; border: 1px solid red; border-radius: 5px; font-size: 14px; font-weight: bold;"><?php _e( 'Note: Free version allows you to show maximum 3 galleries per album on the frontend. Purchase lifetime license <a href="https://mypgc.co/membership/" target="_blank">here</a>. It\'s a one time payment.', 'flash-album-gallery' ); ?></div>
		        <?php
	        }?>
